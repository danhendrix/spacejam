...
const Enemy1 = new NPC('Enemy', 'enemy', '../assets/wizard.png', [
    {
        type: RequirementTypes.question,
        question:
            'Hello! In order to get your first report card you need to answer these questions: What is 2 + 3?',
        answer: 5,
    },
    {
        type: RequirementTypes.question,
...
const Enemy2 = new NPC('Enemy', 'enemy', '../assets/wizard.png', [
    {
        type: RequirementTypes.inventory,
        item: 'report card',
        amount: 1,
        message:
            'I require 1 report card in order to teach you. See if you can go earn one.',
        afterAction: {
            message:
                'Great job getting a report card. Now I will teach you more!',
        },
    },
    {
        type: RequirementTypes.question,
